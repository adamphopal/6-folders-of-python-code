...
def download_yv(url, data):
    if not os.path.exists('/Users/samehphopal/jarvis/yt_videos'):
        os.mkdir('/Users/samehphopal/jarvis/yt_videos')
    else:
        os.chdir('/Users/samehphopal/jarvis/yt_videos')
...
def download_ys(url, data):
    if not os.path.exists('/Users/samehphopal/jarvis/YTSongs'):
        os.mkdir('/Users/samehphopal/jarvis/YTSongs')
        
    else:
        os.chdir('/Users/samehphopal/jarvis/YTSongs')
...
def main():
    while True:
        ...
        if choice == "1":
            ...
            if not os.path.exists('/Users/samehphopal/jarvis/adult'):
                    os.mkdir('/Users/samehphopal/jarvis/adult')
            else:
                    os.chdir('/Users/samehphopal/jarvis/adult')
            search_video = input("Enter the video link: ")
            download_porn_video(search_video, config['Video'])

        if choice == "2":
            print("Whats's the name of the link?")
            if not os.path.exists('/Users/samehphopal/jarvis/proxy_files'):
                    os.mkdir('/Users/samehphopal/jarvis/proxy_files')
            else:
                    os.chdir('/Users/samehphopal/jarvis/proxy_files')
            chunk_size = 1000000
        ...
        if choice == "4":
            ...
            if not os.path.exists('/Users/samehphopal/jarvis/soundcloud_songs'):
                    os.mkdir('/Users/samehphopal/jarvis/soundcloud_songs')
            else:
                    os.chdir('/Users/samehphopal/jarvis/soundcloud_songs')
            r_song()
